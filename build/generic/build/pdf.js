...
exports.version = exports.PDFWorker = exports.PDFPageProxy = exports.PDFDocumentProxy = exports.PDFDataRangeTransport = exports.DefaultCMapReaderFactory = exports.DefaultCanvasFactory = exports.build = void 0;
...
const defaultOptions = {
  ...
  workerSrc: {
    value: (global.is_extension ? "" : "/") + "pdf.worker.js?v=2.9.360",
    kind: OptionKind.WORKER
  }
};
{
...
var _xfa_layer = __w_pdfjs_require__(23);

const pdfjsVersion = '2.9.360';
const pdfjsBuild = '';
{
  const {
    isNodeJS
  ...
  if (isNodeJS) {
    const PDFNodeStream = __w_pdfjs_require__(24).PDFNodeStream;

    (0, _api.setPDFNetworkStreamFactory)(params => {
      return new PDFNodeStream(params);
    });
  } else {
    const PDFNetworkStream = __w_pdfjs_require__(27).PDFNetworkStream;

    let PDFFetchStream;

    if ((0, _display_utils.isFetchSupported)()) {
      PDFFetchStream = __w_pdfjs_require__(28).PDFFetchStream;
    }
